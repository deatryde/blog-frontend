      ...
      <div className="singleBlogWrapper">
        ...
        <h1 className="singleBlogTitle">
          ...
          <div className="singleBlogEdit">
            <i className="singleBlogIcon far fa-edit"></i>
            <i className="singleBlogIcon far fa-trash-alt"></i>
          </div>
        </h1>
        <div className="singleBlogInfo">
          <span>
            Author:
            <b className="singleBlogAuthor">
              <Link className="link" to="/blog?username=Rahul">
                Rahul
              </Link>
            </b>
          </span>
